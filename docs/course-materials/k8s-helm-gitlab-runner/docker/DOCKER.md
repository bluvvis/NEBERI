...
* Use official base images (like python:3.12-slim).
* Minimize the number of layers: Each instruction in a Dockerfile creates a new layer, and having too many layers can impact the image size and build time. (Docker default max layers - 127)
